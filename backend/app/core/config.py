...
class Settings(BaseSettings):
    ...
    # Dify 配置（用于对话式地图操作代理）
    DIFY_API_BASE: str | None = None  # 例如: https://api.dify.ai
    DIFY_API_KEY: str | None = None
    DIFY_APP_ID: str | None = None  # 可选：若需要基于App ID路由
    
    # 地图 Agent API 配置（用于 Dify 工具集成）
    MAP_AGENT_API_BASE: str | None = None  # 例如: http://10.62.111.29:8000（后端服务的完整URL，供 Dify 调用）
